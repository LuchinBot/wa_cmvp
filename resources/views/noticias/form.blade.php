                ...
                <div class="tab-pane fade" id="custom-tabs-02" role="tabpanel">
                    <div class="form-group row">
                        <div class="alert mb-0 mt-1 alert-info p-2" style="font-size:13px;">
                            En este módulo podrá subir la imágen de la noticia. Ten en cuenta las dimensiones de las imágenes (Ancho: {{$dimensiones["ancho"]}}px y Alto: {{$dimensiones["alto"]}}px.)
                        </div>
                    </div>

                    <div class="form-group row">
                        <div class="col-md-6">
                            <label class="required">Imagen Noticia</label>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <div id="vista_previa_llena">
                                        <center><img id="prev_imagen{{$prefix}}" style="width:100%; height:150px; background: #c0c0c0;" src="{{$default_noticia}}" class="img-thumbnail"></img></center>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@foreach ($extend_noticias as $form=>$params)
    @include($form, $params)
@endforeach
...
<script>
    ...
    var _default_imagen_{{$table_name}}   = "{{$default_noticia}}";
</script>
