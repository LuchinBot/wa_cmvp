...
class Pronunciamiento extends Model
{
    ...
    protected $table        = "pronunciamiento";
    protected $primaryKey   = "codpronunciamiento";
    ...
    const PATH_FILE         = 'app/img/pronunciamiento/';
    ...
    public function getColumnDataTable(){
        return [
           ...
           ,["descripcion"=>"Flayer"            ,"ancho"=>"12%", "jsColumn"=>["data"=>"flayer_pronunciamiento", "orderable"=>false, "searchable"=>false, "className"=>"text-center"]]
       ];
    }
}
