...
class Evento extends Model
{
    ...
    const PATH_FILE         = 'app/img/evento/';
    ...
    public function getColumnDataTable(){
        return [
           ...
           ,["descripcion"=>"Descripcion"   ,"ancho"=>"20%", "jsColumn"=>["data"=>"descripcion_evento"]]
           ,["descripcion"=>"Imagen"        ,"ancho"=>"10%", "jsColumn"=>["data"=>"imagen_evento"]]
       ];
    }
}
