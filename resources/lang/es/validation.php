...
return [
    ...
    */
    ...
    'attributes' => [
    	'detalle_productos.*.id'=>'producto descripcion',
		'detalle_productos.*.id_measure_units'=>'producto unidad de medida',
		'detalle_productos.*.id_igv_affectations'=>'producto tipo igv'
	],
