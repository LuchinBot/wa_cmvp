    ...
    <div class="card card-primary card-outline card-tabs" style="margin-bottom: 0rem !important;">
        <div class="card-header p-0 pt-1 border-bottom-0">
            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="custom-tabs-01-tab" data-toggle="pill" href="#custom-tabs-01" role="tab" aria-selected="true">Comunicado</a>
                </li>
                <li class="nav-item">
                ...
                <div class="tab-pane fade active show" id="custom-tabs-01" role="tabpanel">
                    <div class="form-group row">
                        <div class="col-md-12">
                            ...
                            <input type="text" name="titulo" id="titulo{{$prefix}}" class="form-control input-xs" placeholder="Médicos Veterinarios de San Martin, bridan atención a animales silvestres afectados por incendios">
                    ...
                    <div class="form-group row">
                        <div class="col-md-2">
                            <label class="required">Fecha Comunicado</label>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <label class="">Reseña del comunicado</label>
                ...
                <div class="tab-pane fade" id="custom-tabs-02" role="tabpanel" >
                    <div class="form-group row">
                        <div class="alert mb-0 mt-1 alert-info p-2" style="font-size:13px;">
                            En este módulo podrá subir las imágenes del flayer para los comunicados. Ten en cuenta las dimensiones de las imágenes (Ancho: {{$dimension_flayer["ancho"]}}px y Alto: {{$dimension_flayer["alto"]}}px.)
                        </div>
                    </div>
...
@foreach ($extend_comunicados as $form=>$params)
    @include($form, $params)
@endforeach
